...
void Jugador::escribirEnArchivo(FILE *pArchivo)const{ ///recibe como parametro el puntero del archivo
...
///verifica que los datos del jugador fueron recbidos correctamente y sin ningun dato perdido
bool Jugador::leerDeArchivo(FILE *pArchivo){
    ...
    /// 1- lee el nombre
    ///se crea de una variable con memoria dinamica para el nombre + \0
